...
| 28 | Model download + retry | COMPLETE_UNVERIFIED | model_download_task.py + dashboard.py via QThread | HEAD | DownloadTask max_attempts=3, cancel, atomic callbacks, dedup. Wired to model page. Unverified on real HF. | — |
