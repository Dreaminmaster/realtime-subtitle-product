...
ZH_HANS = {
    ...
    "Audio stays on this device. Saved sessions can keep a transcript and an optional recording.": "音频仅保留在本设备；保存会话可保留字幕记录与可选录音。",
    "Session type": "会话类型",
    "Temporary": "临时字幕",
    "Save subtitles": "保存字幕",
    "Subtitles + recording": "字幕＋录音",
    "Choose exactly what remains on this Mac after the session.": "明确选择本次会话结束后要在本机保留的内容。",
    "Choose exactly what remains on this device after the session.": "明确选择本次会话结束后要在本设备保留的内容。",
    ...
    "Saves subtitles and a playable recording locally on this device.": "在本设备保存字幕与可播放的录音。",
    ...
    "Uses Windows WASAPI loopback. No virtual cable or playback-device change is required.": "使用 Windows WASAPI 回环捕获，无需虚拟声卡，也无需切换播放设备。",
    "Playback device:": "播放设备：",
    "Default Windows output": "Windows 默认输出",
    "Sample Rate:": "采样率：",
    ...
    "Saved sessions stay only on this device. Choose Temporary on Live for a session that leaves no history.": "会话仅保存在本设备。在实时字幕页选择“临时会话”即可不留下记录。",
    "Export": "导出",
    ...
    "Tiny/Base prioritizes speed and often splits or mishears natural speech. Use Small for everyday accuracy or Turbo on a capable computer.": "Tiny / Base 更偏重速度，容易把自然语句切碎或听错。日常使用建议 Small，性能较好的电脑建议 Turbo。",
    ...
    "Balanced is recommended. Efficient lowers heat; High accuracy is intended for faster or externally cooled computers and still requires an optional refinement model.": "推荐使用均衡。节能模式可降低发热；高精度适合性能更强或散热条件更好的电脑，并且仍需按需下载可选修正模型。",
    ...
    "Get signed releases, version details, and release notes without leaving the app.": "无需离开应用即可获取经过签名的版本、版本提示和更新说明。",
    "Check for Updates…": "检查更新…",
    "Automatically download and install updates": "自动下载并安装更新",
    "Update service is available in the packaged macOS app.": "更新服务仅在打包后的 macOS 应用中可用。",
    "Updates are verified by Sparkle before installation.": "安装前会由 Sparkle 验证更新签名。",
    "Checking for updates…": "正在检查更新…",
    "Update service is unavailable in this build.": "此构建中未提供更新服务。",
    "Automatic updates are on.": "已开启自动更新。",
    "Automatic updates are off.": "已关闭自动更新。",
    # Translation.
    ...
    "Built-in offline translation": "内置离线翻译",
    "Built in": "已内置",
    ...
    "Audio and settings stay on this device.": "音频与设置仅保留在本设备。",
    "Support": "支持",
