...
ZH_HANS = {
    ...
    "Efficient": "节能",
    "Maximum": "最高性能",
    "Balanced is recommended. Efficient lowers heat; Maximum is intended for faster or externally cooled Macs.": "推荐使用均衡。节能模式可降低发热；最高性能适合更快或具有额外散热条件的 Mac。",
    ...
    "These downloads are only for speech recognition. Translation models are selected on the Translation page and are managed by that service.": "这里下载的仅是语音识别模型。翻译模型请在“翻译”页面选择，并由对应翻译服务管理。",
